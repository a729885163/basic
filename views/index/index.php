...
<html lang="en">
	<head>
	    ...
	    <link rel="stylesheet" href="<?php echo CSS_URL; ?>green.css">
	    <link rel="stylesheet" href="<?php echo CSS_URL; ?>owl.carousel.css">
		<link rel="stylesheet" href="<?php echo CSS_URL; ?>owl.transitions.css">
		<link rel="stylesheet" href="<?php echo CSS_URL; ?>animate.min.css">

		<!-- Demo Purpose Only. Should be removed in production -->
		<link rel="stylesheet" href="<?php echo CSS_URL; ?>config.css">

		<link href="<?php echo CSS_URL; ?>green.css" rel="alternate stylesheet" title="Green color">
		<link href="<?php echo CSS_URL; ?>blue.css" rel="alternate stylesheet" title="Blue color">
		<link href="<?php echo CSS_URL; ?>red.css" rel="alternate stylesheet" title="Red color">
		<link href="<?php echo CSS_URL; ?>orange.css" rel="alternate stylesheet" title="Orange color">
		<link href="<?php echo CSS_URL; ?>navy.css" rel="alternate stylesheet" title="Navy color">
		<link href="<?php echo CSS_URL; ?>dark-green.css" rel="alternate stylesheet" title="Darkgreen color">
...
<div class="logo">
	<a href="index.html">
		<!--<img alt="logo" src="<?php echo IMG_URL; ?>logo.svg" width="233" height="54"/>-->
		<!--<object id="sp" type="image/svg+xml" data="<?php echo IMG_URL; ?>logo.svg" width="233" height="54"></object>-->
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <div class="basket-item-count">
                    ...
                    <img src="<?php echo IMG_URL; ?>icon-cart.png" alt="" />
                </div>
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="thumb">
                                    <img alt="" src="<?php echo IMG_URL; ?>products/product-small-01.jpg" />
                                </div>
                            </div>
...
<div class="row">
    ...
    <div class="dropdown-banner-holder">
        <a href="#"><img alt="" src="<?php echo IMG_URL; ?>banners/banner-side.png" /></a>
    </div>
</div>
<!-- ================================== MEGAMENU VERTICAL ================================== -->                        
                    </li>
...
<div id="hero">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		...
		<div class="item" style="background-image: url(<?php echo IMG_URL; ?>sliders/slider01.jpg);">
		...
		<div class="item" style="background-image: url(<?php echo IMG_URL; ?>sliders/slider03.jpg);">
			<div class="container-fluid">
				<div class="caption vertical-center text-left">
					<div class="big-text fadeInDown-1">
    ...
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
            <a href="category-grid-2.html">
                ...
                <img class="banner-image" alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>banners/banner-narrow-01.jpg" />
            </a>
        </div>
        <div class="col-xs-12 col-lg-6 no-margin text-right banner">
            <a href="category-grid-2.html">
                ...
                <img class="banner-image" alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>banners/banner-narrow-02.jpg" />
            </a>
        </div>
    </div><!-- /.container -->
                    ...
                    <div class="product-grid-holder">
                        <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-01.jpg" />
                                </div>
                                <div class="body">
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-02.jpg" />
                                </div>
                                <div class="body">
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-03.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-04.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
            ...
            <div class="col-xs-12 col-md-7 no-margin">
                ...
                <div class="row no-margin">
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-05.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-06.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-07.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-08.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-09.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-10.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                                <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-gallery-01.jpg" />
                            </a>
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                            <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/gallery-thumb-01.jpg" /></a></li>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="1" href="#slide2"><img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/gallery-thumb-01.jpg" /></a></li>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="2" href="#slide3"><img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/gallery-thumb-01.jpg" /></a></li>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
			...
			<div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
				<div class="no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						<div class="ribbon red"><span>sale</span></div> 
						<div class="image">
							<img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-11.jpg" />
						</div>
						<div class="body">
							<div class="title">
				...
				<div class="no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						<div class="ribbon blue"><span>new!</span></div> 
						<div class="image">
							<img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-12.jpg" />
						</div>
						<div class="body">
							<div class="title">
				...
				<div class=" no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						...
						<div class="image">
							<img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-13.jpg" />
						</div>
						<div class="body">
							<div class="title">
				...
				<div class=" no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						<div class="ribbon blue"><span>new!</span></div> 
						<div class="image">
							<img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-14.jpg" />
						</div>
						<div class="body">
							<div class="title">
				...
				<div class=" no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						<div class="ribbon green"><span>bestseller</span></div> 
						<div class="image">
							<img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-15.jpg" />
						</div>
						<div class="body">
							<div class="title">
				...
				<div class=" no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						...
						<div class="image">
							<img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-16.jpg" />
						</div>
						<div class="body">
							<div class="title">
        ...
        <div class="carousel-holder" >
            ...
            <div id="owl-brands" class="owl-carousel brands-carousel">
                ...
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<?php echo IMG_URL; ?>brands/brand-01.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<?php echo IMG_URL; ?>brands/brand-02.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<?php echo IMG_URL; ?>brands/brand-03.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="<?php echo IMG_URL; ?>brands/brand-04.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
        ...
        <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-01.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-02.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">                        
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-03.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-04.jpg" />
                        </a>
                    </div>
                </div>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-05.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-06.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-07.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-08.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="<?php echo IMG_URL; ?>blank.gif" data-echo="<?php echo IMG_URL; ?>products/product-small-09.jpg" />
                        </a>
                    </div>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="<?php echo IMG_URL; ?>payments/payment-visa.png"></li>
                        <li><img alt="" src="<?php echo IMG_URL; ?>payments/payment-master.png"></li>
                        <li><img alt="" src="<?php echo IMG_URL; ?>payments/payment-paypal.png"></li>
                        <li><img alt="" src="<?php echo IMG_URL; ?>payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
...
<!-- ============================================================= FOOTER : END ============================================================= -->	</div><!-- /.wrapper -->
	...
	<script src="<?php echo JS_URL; ?>jquery-migrate-1.2.1.js"></script>
	<script src="<?php echo JS_URL; ?>bootstrap.min.js"></script>
	<!-- <script src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script> -->
	<script src="<?php echo JS_URL; ?>gmap3.min.js"></script>
	<script src="<?php echo JS_URL; ?>bootstrap-hover-dropdown.min.js"></script>
	<script src="<?php echo JS_URL; ?>owl.carousel.min.js"></script>
	<script src="<?php echo JS_URL; ?>css_browser_selector.min.js"></script>
	<script src="<?php echo JS_URL; ?>echo.min.js"></script>
	<script src="<?php echo JS_URL; ?>jquery.easing-1.3.min.js"></script>
	<script src="<?php echo JS_URL; ?>bootstrap-slider.min.js"></script>
    <script src="<?php echo JS_URL; ?>jquery.raty.min.js"></script>
    <script src="<?php echo JS_URL; ?>jquery.prettyPhoto.min.js"></script>
    <script src="<?php echo JS_URL; ?>jquery.customSelect.min.js"></script>
