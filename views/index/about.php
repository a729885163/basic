				...
				<section id="our-team">
					...
					<ul class="team-members list-unstyled">
						...
						<li class="team-member">
							<img src="<?php echo IMG_URL; ?>team/1.jpg" alt="" class="profile-pic img-responsive">
							<div class="profile">
						...
						<li class="team-member">
							<img src="<?php echo IMG_URL; ?>team/2.jpg" alt="" class="profile-pic img-responsive">
							<div class="profile">
	...
	<section id="our-clients" class="row inner-sm">
		<div class="container">
			...
			<ul class="list-unstyled row list-clients">
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo IMG_URL; ?>brands/brand-01.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo IMG_URL; ?>brands/brand-02.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo IMG_URL; ?>brands/brand-03.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo IMG_URL; ?>brands/brand-04.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo IMG_URL; ?>brands/brand-01.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo IMG_URL; ?>brands/brand-02.jpg" /></a></li>
			</ul>
		</div>
	...
	<div class="config open">
		<div class="config-options">
			...
			<ul class="list-unstyled">
				<li><a href="about.html1">Header 1</a></li>
				<li><a href="about.html">Header 2</a></li>
			</ul>
			<h4>Colors</h4>
			<ul class="list-unstyled">
