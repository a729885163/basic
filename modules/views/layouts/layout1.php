...
<head>
    ...
    <!-- libraries -->
    <link href="<?php echo ADMIN_CSS_URL; ?>lib/jquery-ui-1.10.2.custom.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" href="<?php echo ADMIN_CSS_URL; ?>compiled/index.css" type="text/css" media="screen" />    
...
<body>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                <a class="dropdown-toggle" href="<?php echo yii\helpers\Url::to(['default/tables']) ?>">
                    <i class="icon-edit"></i>
                    <span>表单</span>
                    <i class="icon-chevron-down"></i>
                </a>
            ...
            <li>
                <a href="<?php echo yii\helpers\Url::to(['default/tables']) ?>">
...
<?php echo $content; ?>
    ...
    <script src="<?php echo ADMIN_JS_URL; ?>jquery-ui-1.10.2.custom.min.js"></script>
    <!-- knob -->
    <script src="<?php echo ADMIN_JS_URL; ?>jquery.knob.js"></script>
    <!-- flot charts -->
    <script src="<?php echo ADMIN_JS_URL; ?>jquery.flot.js"></script>
    <script src="<?php echo ADMIN_JS_URL; ?>jquery.flot.stack.js"></script>
    <script src="<?php echo ADMIN_JS_URL; ?>jquery.flot.resize.js"></script>
